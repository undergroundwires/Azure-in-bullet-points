...
- Provides high availability through [regional or multiple Availability Zones](https://docs.microsoft.com/en-us/azure/virtual-machine-scale-sets/availability#virtual-machines-scale-sets) deployment options.
