...
- Evaluates bot new and existing resources for compliance.
  ...
  - Can alter alter the resource properties.
...
- Implementation: Create an Azure Blueprint -> Assign the blueprint -> Track the blueprint assignments
