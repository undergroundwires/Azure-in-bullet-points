...
- ❗No SLA, development and testing only
  - Azure suspends VM's used for production or that run more than 120 hours.
...
- Purchase Windows/Linux VM's for one-year or three-year terms with payment of entire period or monthly.
